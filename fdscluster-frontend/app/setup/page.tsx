...
export default function SetupPage() {
	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-200 via-blue-500 to-primary-light overflow-hidden relative">
			{mounted && (
				<>
					<motion.div
			...
			<div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-black to-transparent opacity-30" />
